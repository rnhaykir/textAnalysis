...
classifier = [GradientBoostingClassifier(n_estimators=50, learning_rate=0.1, max_depth=5, random_state=42), CatBoostClassifier(
    iterations=100, learning_rate=0.1, depth=5), XGBClassifier(learning_rate=0.1, max_depth=5, n_estimators=100)]
